...
from controller.constants import STIM_MAX_CHUNKED_SUBPROTOCOL_DUR_MICROSECONDS
from controller.constants import STIM_MIN_SUBPROTOCOL_DURATION_MICROSECONDS
from controller.utils import stimulation
from controller.utils.stimulation import chunk_protocols_in_stim_info
from controller.utils.stimulation import chunk_stim_nodes
from controller.utils.stimulation import chunk_subprotocol
import pytest
...
from ..helpers import random_stim_type
...
def test_chunk_protocols_in_stim_info__returns_correct_values(mocker):
    ...
    # test mapping
    assert subprotocol_idx_mappings == {0: {0: 0, 1: 0, 2: 1}, 1: {0: 0, 1: 1, 2: 2, 3: 2}}

    # test counters
    assert max_subprotocol_idx_counts == {
        0: (mocked_chunk_subprotocol_returns[0][0]["num_iterations"] + 1, 1),
        1: (1, 1, mocked_chunk_subprotocol_returns[4][0]["num_iterations"] + 1),
    }

...
extensions = [
    Extension(
        "stingray_controller.utils.data_parsing_cy",
        [
            os.path.join("src", "stingray_controller", "utils", "data_parsing_cy") + ext,
...
setup(
    name="stingray_controller",
    # Eli (1/25/21): the version is obtained from package.json during CI as the single source of truth
    description="Windows Desktop App for viewing and recording data from a Stingray Instrument.",
    url="https://github.com/curibio/stingray-controller",
    author="Curi Bio",

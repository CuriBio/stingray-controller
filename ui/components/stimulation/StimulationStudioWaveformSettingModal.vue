<template>
  <div
    ...
    :style="pulseType === 'Monophasic' ? 'height: 570px; margin-top: 100px;' : 'height: 840px;'"
  >
    ...
    <div class="div__pulse-diagram-container">
      <img
        ...
        :class="pulseType === 'Monophasic' ? 'img__mononphasic-diagram' : 'img__biphasic-diagram'"
      />
    </div>
    <div
    ...
    <div class="button-container" :style="pulseType === 'Monophasic' ? 'top: 565px;' : 'top: 790px;'">
      <ButtonWidget
        :id="'button-widget-id'"
